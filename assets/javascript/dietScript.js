...
function renderDietBtns() {
    ...
    if(userCondition == 1) {
       ...
       var btn3 = $("<button>").attr("class", "border btn btn-lg mb-2 text-center").attr('onClick', 'openClickedDiet(id)').attr('id', "low-carb").css('display','block').text("Low Carb");                           
        ...
        var btn1 = $("<button>").attr("class", "border btn btn-lg mb-2 text-center").attr('onClick', 'openClickedDiet(id)').attr('id', "cholesterol-free").css('display','block').text("Cholesterol Free"); 
